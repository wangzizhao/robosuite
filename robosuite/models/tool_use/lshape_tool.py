...
class LShapeTool(CompositeObject):
    def __init__(
        ...
        add_to_dict(
            ...
            geom_sizes=np.array([0.11, 0.02, 0.02]),
            geom_names=f"body_0",
            geom_rgbas=None,
        ...
        add_to_dict(
            dic=obj_args,
            geom_types="box",
            geom_locations=(0.16, 0.08, 0.0),
            geom_quats=T.convert_quat(T.axisangle2quat(np.array([0, 0, 0])), to="wxyz"),
            geom_sizes=np.array([0.01, 0.04, 0.02]),
            geom_names=f"body_1",
            geom_rgbas=None,
            geom_materials=geom_mat,
            geom_frictions=geom_frictions,
        ...
        add_to_dict(
            dic=obj_args,
            geom_types="box",
            geom_locations=(0.16, 0.01, 0.0),
            geom_quats=T.convert_quat(T.axisangle2quat(np.array([0, 0, 0])), to="wxyz"),
            geom_sizes=np.array([0.01, 0.03, 0.02]),
            geom_names=f"body_2",
            geom_rgbas=None,
            geom_materials=geom_mat,
            geom_frictions=geom_frictions,
